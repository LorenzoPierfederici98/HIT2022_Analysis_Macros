 ...
 * @brief Header file for CaloPeakEnergyDisplay.cc.
 * 
 ...
 * An intercalibration is then performed for those crystals with at least 2 fitted charge peaks out of 5 energy
 * values, by computing the ratio of the slopes of a certain crystal with respect to crystal ID 0 (the central
 * crystal). The calibration coefficients for every available crystal are stored in a file named SlopeRatios.cal.
 */
