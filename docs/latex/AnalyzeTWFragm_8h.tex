...
Include dependency graph for Analyze\+TWFragm.\+h\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{AnalyzeTWFragm_8h__incl}
\end{center}
\end{figure}
...
std\+::pair$<$ TFit\+Result\+Ptr, TFit\+Result\+Ptr $>$ \mbox{\hyperlink{AnalyzeTWFragm_8h_a65f48b2f9841534aef2f32eb95f83b43}{Fit\+Peaks\+With\+TSpectrum}} (TH1D \texorpdfstring{$\ast$}{*}hist, double energy, double thresh\+\_\+peak\+\_\+low, double thresh\+\_\+peak\+\_\+high, const TString \&layer\+Bar\+Combination)
...
This function fits the histograms in the specified directory using two separate Gaussian functions, one for proton peaks and one for helium peaks. The fit limits depend on the beam energy. Only histograms with entries greater than a specified threshold are fitted. The fit results are stored in the provided maps.
...
\hline
\end{DoxyParams}
\Hypertarget{AnalyzeTWFragm_8h_a65f48b2f9841534aef2f32eb95f83b43}\label{AnalyzeTWFragm_8h_a65f48b2f9841534aef2f32eb95f83b43} 
...
{\footnotesize\ttfamily std\+::pair$<$ TFit\+Result\+Ptr, TFit\+Result\+Ptr $>$ Fit\+Peaks\+With\+TSpectrum (\begin{DoxyParamCaption}\item[{TH1D \texorpdfstring{$\ast$}{*}}]{hist,  }\item[{double}]{energy,  }\item[{double}]{thresh\+\_\+peak\+\_\+low,  }\item[{double}]{thresh\+\_\+peak\+\_\+high,  }\item[{const TString \&}]{layer\+Bar\+Combination }\end{DoxyParamCaption})}
...
{\em energy} & Beam energy. \\
\hline
{\em thresh\+\_\+peak\+\_\+low} & Lower threshold for peak search. \\
\hline
{\em thresh\+\_\+peak\+\_\+high} & Upper threshold for peak search. \\
\hline
...
This function processes the specified ROOT file, sums the number of entries, calculates the threshold, and fits the histograms in the specified directories. The fit results are stored in the provided maps.
