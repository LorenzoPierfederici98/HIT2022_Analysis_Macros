...
void \mbox{\hyperlink{CalibrateTof_8h_a2976661d2feaa11e0d6d557df1dbdf05}{Write\+Mean\+Differences}} (const std\+::vector$<$ std\+::pair$<$ std\+::string, int $>$ $>$ \&files\+And\+Energies, const std\+::vector$<$ std\+::pair$<$ std\+::string, int $>$ $>$ \&files\+And\+Energies\+MC, const std\+::string \&layer, int bar)
...
\end{DoxyReturn}
\Hypertarget{CalibrateTof_8h_a2976661d2feaa11e0d6d557df1dbdf05}\label{CalibrateTof_8h_a2976661d2feaa11e0d6d557df1dbdf05} 
...
{\footnotesize\ttfamily void Write\+Mean\+Differences (\begin{DoxyParamCaption}\item[{const std\+::vector$<$ std\+::pair$<$ std\+::string, int $>$ $>$ \&}]{files\+And\+Energies,  }\item[{const std\+::vector$<$ std\+::pair$<$ std\+::string, int $>$ $>$ \&}]{files\+And\+Energies\+MC,  }\item[{const std\+::string \&}]{layer,  }\item[{int}]{bar }\end{DoxyParamCaption})}
